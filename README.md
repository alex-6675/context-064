...
Индивидуальный менеджер репутаций пользователей социальной сети ВКонтакте, оформленный как расширение для браузера Chrome. Расширение работает только в Chrome и поддерживает только русский язык.

**Внимание:** данный репозиторий содержит версию расширения, предназначенную исключительно для тестирования в режиме разработчика. Установка производится вручную, манифест не предназначен для публикации в Chrome Web Store.

## Поддерживаемая социальная сеть
- ВКонтакте (vk.com)
